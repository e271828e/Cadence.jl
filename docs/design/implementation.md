...
| `src/devices.jl` | the device contract, the handle, the task wrapper, the init bracket and the tail under `join_timeout`; the two lifecycle gates, the readers' and the roster's | §11.1, §11.3, §11.6, §12.1–§12.4, §13.6, D-198, D-232 |
