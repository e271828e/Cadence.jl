...
function probe_stage1(s::Structure, decls::Vector{Decls},
    ...
    map(eachindex(s.comps)) do ci
        ...
        at_component(path) do
            _frozen(s.tiers, ci, T) && return carry.stage1[ci]
...
function _check_wires(s::Structure, diags::Vector{Diagnostic})
